// Copyright 2019 LoggingTimings Contributors
//
...
namespace LoggingTimings
{
    ...
    public static class OperationExtensions
    {
        ...
        // /// <seealso cref="Operation.Abandon(PropertyContext)"/>
        ...
        //     => operation.Abandon(new PropertyContext(resultPropertyName, result, destructureObjects));
